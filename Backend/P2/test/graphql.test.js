...
describe('Database check', () => {
  it('database should return signal doc with correct id', (done) => {
    const hexId = signals[0]._id.toHexString()
  ...
  it('database should return decision doc with correct id', (done) => {
    const hexId = decisions[0]._id.toHexString()
  ...
  it('return all signals', (done) => {
    request(app).post('/graphql')
      ...
      .end((err, res) => {
        ...
        const allSignals = res.body.data.allSignals
  ...
  it('return all decisions', (done) => {
    request(app).post('/graphql')
      ...
      .end((err, res) => {
        ...
        const allDecisions = res.body.data.allDecisions
  ...
  it('return all analyst decisions', (done) => {
    request(app).post('/graphql')
      ...
      .end((err, res) => {
        ...
        const allAnalysts = res.body.data.getAnalysts
